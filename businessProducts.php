...
<div class="main-banner2">
        <img src="Images/businessBanner.png" alt="" width="350" height="500"></img>
        <div id="punchline2">
          <h2>Uma empresa do futuro, pensa no futuro</h2>
        </div>
...
foreach ($productsColection2 as $key => $value) {
 
?>
<img src= "testImage2.jpg" width= "400px">
